...
// Crear proyecto automático asociado a la solicitud.
...
// Reglas de productos automáticos según los datos del formulario.
$rules=[];
...
try{$db->prepare('INSERT INTO quote_labor_items(quote_id,title,description,amount,tax_mode,vat_rate,block_order) VALUES(?,?,?,?,?,?,?)')->execute([$quoteId,'Mano de obra','Configuración, montaje y diseño de escenas',0,'sin_iva',21,20]);}catch(Throwable $e){}
