...
(function(){
 ...
 const statement=document.createElement('a');statement.className='btn light';statement.href='?a=project_statement&id=$projectId';statement.target='_blank';statement.textContent='Resumen para el cliente / PDF';top.appendChild(statement);
