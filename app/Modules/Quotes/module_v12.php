...
if(in_array($a,['save_quote','update_quote'],true)){
    ...
    try{
        ...
        $db->commit();$_SESSION['msg']=$a==='update_quote'?'Presupuesto actualizado.':'Presupuesto creado. Podés seguir editándolo o generar el PDF cuando quieras.';header('Location:index.php?a=edit_quote&id='.$qid);exit;
