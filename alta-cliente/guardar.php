...
$siteRoot=dirname(__DIR__);$configFile=null;foreach([$siteRoot.'/config.php',$siteRoot.'/erp/config.php',$siteRoot.'/erp-dev/config.php'] as $candidate){if(is_file($candidate)){$configFile=$candidate;break;}}
...
try{
    ...
    if(!mail('iescobar@puntodomotica.com',$subject,$body,$headers))error_log('Punto ERP: no se pudo enviar el aviso de alta del cliente '.$businessName);
